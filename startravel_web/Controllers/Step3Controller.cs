...
namespace startravel_web.Controllers
{
    public class Step3Controller : Controller
    {
        //
        // GET: /Step3/
        public async Task<ActionResult> Index(string order_number, string member_number, string member_id_no)
        {
            ...
            step3_view_return_data step3_view_data = new step3_view_return_data { paymentorder_result = paymentorder_source, tcashavblbalance_result = tcashavblbalance_source, orderinstallment_result = orderinstallment_source, order_no = order_no_s, member_id_no = member_id_no, member_no = member_number };
          ...
          //  Response.Write("ordergrpcreate_source.rCode:" + ordergrpcreate_source.rCode + "<br/>");
           // Response.Write("ordergrpcreate_source.rCodeDesc:" + ordergrpcreate_source.rCodeDesc + "<br/>");
            ...
            if (ordergrpcreate_source.rCode.Equals("0001"))
            {
                ...
                return RedirectToAction("Index", "Step3", new { order_number = ordergrpcreate_source.Data.ORDER_NO, member_number = member_no_hidden, member_id_no = member_id_no_hidden });
