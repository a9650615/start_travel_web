...
namespace startravel_web.Controllers
{
    public class Step3_1Controller : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            step3_1_view_return_data step3_1_view_data = new step3_1_view_return_data { orderinfomation_result = orderinfomation_source, tcash = tcash_i, atmtransferaccount_result = atmtransferaccount_source };
