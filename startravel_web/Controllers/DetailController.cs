         ...
         //   string prod_no_s ="IGRP000018712";
          //  string grp_no_s = "BKK05ITA0217A";
           ...
           // string travel_region_s=TravelRegion;
            ...
            DateTime current_date_d = DateTime.ParseExact(current_date, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture);
            DateTime NEXT_date_d;
            NEXT_date_d = current_date_d.AddMonths(1);
            string next_date = NEXT_date_d.ToString("yyyyMM");
           ...
           /// IGRPTrafficInfo_PostData igrptrafficinfo_postData = new IGRPTrafficInfo_PostData() { prod_no = "IGRP000018191", grp_no = "OKA04IT31617T" };
            GRPCalendar_PostData grpcalendar_postData = new GRPCalendar_PostData() { prod_no = prod_no_s, s_month = current_date_d.ToString("yyyyMM"), e_month = next_date };
           ...
           //var grpcalendar_source_test = await api.GRPCalendar_api_test(grpcalendar_postData);
           ...
           //Response.Write(grpcalendar_source_test);
           //Response.Write("grpcalendar_source=" + grpcalendar_source.rCodeDesc);
